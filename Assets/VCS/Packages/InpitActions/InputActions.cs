...
//     version 1.11.2
//     from Assets/VCS/Packages/InpitActions/InputActions.inputactions
//
...
public partial class @InputActions: IInputActionCollection2, IDisposable
{
    ...
    ~@InputActions()
    {
        UnityEngine.Debug.Assert(!m_VirtualStick.enabled, "This will cause a leak and performance issues, InputActions.VirtualStick.Disable() has not been called.");
    }
    ...
    public struct VirtualStickActions
    {
        ...
        public VirtualStickActions(@InputActions wrapper) { m_Wrapper = wrapper; }
