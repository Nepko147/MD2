...
public class ControlPers_LanguageHandler_English : ControlPers_LanguageHandler_Parent
{
    protected override void Awake()
    {
        ...
        text_keyToString[Text_Key.received_ad_text] = "Get x" + ControlPers_BuildSettings.BUILDTYPE_RUNTIME_WEB_YANDEXGAMES_AD_MULT + " for watching ads"; //Get x3 for watching ads
