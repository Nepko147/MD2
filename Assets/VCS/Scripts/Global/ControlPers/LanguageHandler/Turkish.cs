...
public class ControlPers_LanguageHandler_Turkish : ControlPers_LanguageHandler_Parent
{
    protected override void Awake()
    {
        ...
        text_keyToString[Text_Key.received_ad_text] = "Reklamları izlemek için x" + ControlPers_BuildSettings.BUILDTYPE_RUNTIME_WEB_YANDEXGAMES_AD_MULT + " kazanın"; //Get x3 for watching ads
