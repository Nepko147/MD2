...
public class ControlPers_LanguageHandler_Belarusian : ControlPers_LanguageHandler_Parent
{
    protected override void Awake()
    {
        ...
        text_keyToString[Text_Key.received_ad_text] = "Атрымайце x" + ControlPers_BuildSettings.BUILDRUNTIMETYPE_WEB_YANDEXGAMES_AD_MULT + " за прагляд рэкламы"; //Get x3 for watching ads
