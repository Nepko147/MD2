...
public class ControlPers_LanguageHandler_Kazakh : ControlPers_LanguageHandler_Parent
{
    protected override void Awake()
    {
        ...
        text_keyToString[Text_Key.received_ad_text] = "Жарнамалар көру үшін x" + ControlPers_BuildSettings.BUILDTYPE_RUNTIME_WEB_YANDEXGAMES_AD_MULT + " алыңыз"; //Get x3 for watching ads
