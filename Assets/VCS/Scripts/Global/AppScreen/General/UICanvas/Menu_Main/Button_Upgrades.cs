...
public class AppScreen_General_UICanvas_Menu_Main_Button_Upgrades : AppScreen_General_UICanvas_Button_Parent
{
    public static AppScreen_General_UICanvas_Menu_Main_Button_Upgrades SingleOnScene { get; private set; }
