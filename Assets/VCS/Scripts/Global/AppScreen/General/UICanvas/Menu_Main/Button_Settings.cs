...
public class AppScreen_General_UICanvas_Menu_Main_Button_Settings : AppScreen_General_UICanvas_Button_Parent
{
    public static AppScreen_General_UICanvas_Menu_Main_Button_Settings SingleOnScene { get; private set; }
