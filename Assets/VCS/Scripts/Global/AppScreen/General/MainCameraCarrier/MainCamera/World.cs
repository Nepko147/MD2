...
public class AppScreen_General_MainCameraCarrier_MainCamera_World : AppScreen_General_MainCameraCarrier_MainCamera_Parent
{
    ...
    {
        //Применяем шейдер к исходной рендер-текстуре камеры текущего GameObject'а. Затем помещаем результат в конечную рендер-текстуру камеры текущего GameObject'а
