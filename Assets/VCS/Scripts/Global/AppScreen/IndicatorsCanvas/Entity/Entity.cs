...
public class AppScreen_Canvas_Entity : MonoBehaviour
{
    public static AppScreen_Canvas_Entity Singletone { get; private set; }
    ...
    private void FixedUpdate()
    {
        ...
        appScreen_canvas_ups_string_text.text = APPSCREEN_CANVAS_TEXT_X + World_Player.Singletone.Plyer_Ups;
