...
public class AppScreen_Local_SceneMain_UICanvas_Indicators_MidScreen_BigString : AppScreen_General_UICanvas_Parent
{
    public static AppScreen_Local_SceneMain_UICanvas_Indicators_MidScreen_BigString SingleOnScene { get; private set; }
