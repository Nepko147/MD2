...
public class AppScreen_Local_SceneMenu_UICanvas_Menu_Local_Settings_Language_Button_Es : AppScreen_General_UICanvas_Button_Parent
{
    public static AppScreen_Local_SceneMenu_UICanvas_Menu_Local_Settings_Language_Button_Es SingleOnScene { get; private set; }

    private void ImageRefresh()
    {
        Image_LanguageRefresh(ControlPers_LanguageHandler.ButtonName.switch_es);
    }
    ...
    public override void OnClick()
    {
        ...
        ControlPers_LanguageHandler.SingleOnScene.SetGameLanguage(ControlPers_LanguageHandler.GameLanguage.spanish);
