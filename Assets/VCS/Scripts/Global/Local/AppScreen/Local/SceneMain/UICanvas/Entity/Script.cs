...
public class AppScreen_Local_SceneMain_UICanvas_Entity : MonoBehaviour
{
    ...
    private const string TEXT_GAMEOVER_MAIN = "GAME OVER";
    private const string TEXT_GAMEOVER_DISTANCEREMAIN_PREF = "Distance remain: ";
    ...
    public void ShowGameOver()
    {
        ...
        AppScreen_Local_SceneMain_UICanvas_Indicators_MidScreen_SmallString.SingleOnScene.UpdateText(TEXT_GAMEOVER_DISTANCEREMAIN_PREF + AppScreen_Local_SceneMain_UICanvas_Indicators_Complete_Entity.SingleOnScene.Text_Number + TEXT_GAMEOVER_DISTANCEREMAIN_SUFF);
    }
